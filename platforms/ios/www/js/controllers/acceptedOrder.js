...
.controller('acceptedOrderCtrl',['$scope','$location','$interval','$ionicPopup','MediaSrv','$ionicModal','$cordovaToast','config','$http','bfgData','$state','$rootScope','$ionicActionSheet','$cordovaStarPrint','$timeout','$cordovaScreenshot','$ionicPosition', function($scope,$location,$interval,$ionicPopup,MediaSrv,$ionicModal,$cordovaToast,config,$http,bfgData,$state,$rootScope,$ionicActionSheet,$cordovaStarPrint, $timeout,$cordovaScreenshot,$ionicPosition) {
