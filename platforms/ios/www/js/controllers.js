...
.controller('AppCtrl',['$scope', '$ionicModal', '$timeout', '$location','$interval','$ionicPopup','$cordovaToast','$http','config','$state' ,'$cordovaStarPrint', function($scope, $ionicModal, $timeout, $location,$interval,$ionicPopup,$cordovaToast,$http,config,$state, $cordovaStarPrint) {
