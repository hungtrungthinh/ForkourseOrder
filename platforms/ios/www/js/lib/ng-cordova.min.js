...
! function() {
    ...
    }]).run(["$cordovaNetwork", function() {}]), angular.module("ngCordova.plugins.oauth", ["ngCordova.plugins.oauthUtility","ngCordova.plugins.progressIndicator"]).factory("$cordovaOauth", ["$q", "$http", "$cordovaOauthUtility","$cordovaProgress", function(e, n, t ,z) {
        return {
            adfs: function(t, r, o) {
                var i = e.defer();
                if (window.cordova) {
            ...
            linkedin: function(t, r, o, i,q) {
                var a = e.defer();
                if (window.cordova) {
                    var c = cordova.require("cordova/plugin_list").metadata;
                    if (c.hasOwnProperty("org.apache.cordova.inappbrowser") === !0) {
                        var u = window.open("https://www.linkedin.com/uas/oauth2/authorization?client_id=" + t + "&redirect_uri="+q+"&scope=" + o.join(" ") + "&response_type=code&state=" + i, "_blank", "location=no,clearsessioncache=yes,clearcache=yes");
						
						/*u.addEventListener('loadstart', inAppBrowserbLoadStart);
						u.addEventListener('loadstop', inAppBrowserbLoadStop);
						u.addEventListener('loaderror', inAppBrowserbLoadStop);
						u.addEventListener('exit', inAppBrowserbLoadStop); 
                        ...
                        u.addEventListener("loadstart", function(e) {
                            0 === e.url.indexOf(q) && (requestToken = e.url.split("code=")[1], n.defaults.headers.post["Content-Type"] = "application/x-www-form-urlencoded", n({
                                method: "post",
                                url: "https://www.linkedin.com/uas/oauth2/accessToken",
                                data: "client_id=" + t + "&client_secret=" + r + "&redirect_uri="+q+"&grant_type=authorization_code&code=" + requestToken
                            }).success(function(e) {
                                a.resolve(e)
                            }).error(function() {
    ...
    }]), angular.module("ngCordova.plugins.starPrint", []).factory("$cordovaStarPrint", ["$q", "$window", function(e, n) {
        return {
            setting: function() {
                var r = e.defer();
                return n.plugins.StarPrinterPlugin.setting(function(e) {
                    r.resolve(e)
                }, function(e) {
                    r.reject(e)
                }), r.promise
            ...
            preSetting: function() {
                var r = e.defer();
                return n.plugins.StarPrinterPlugin.preSetting(function(e) {
                    r.resolve(e)
                }, function(e) {
                    r.reject(e)
                }), r.promise
            ...
            print: function() {
                var r = e.defer();
                return n.plugins.StarPrinterPlugin.print(function(e) {
                    r.resolve(e)
                }, function(e) {
                    r.reject(e)
                }), r.promise
    ...
    }]),angular.module("ngCordova.plugins.screenshot", []).service('$cordovaScreenshot', ['$q', function ($q){
        return {
