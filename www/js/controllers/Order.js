...
.controller('OrderCtrl',['$scope','$location','$interval','$timeout','$ionicPopup','MediaSrv','$ionicModal','$cordovaToast','config','$http','bfgData','$state','$rootScope','$cordovaMedia','$ionicLoading', function($scope,$location,$interval,$timeout,$ionicPopup,MediaSrv,$ionicModal,$cordovaToast,config,$http,bfgData,$state,$rootScope,$cordovaMedia,$ionicLoading) {
