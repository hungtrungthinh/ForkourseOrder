...
// For example's sake, hide the sheet after two s
    $timeout(function() {
        hideSheet();
        }, 2000);*/
        $scope.previewmodalshow();
