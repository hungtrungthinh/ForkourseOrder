...
.controller('cancelledOrderCtrl',['$scope','$location','$interval','$ionicPopup','MediaSrv','$ionicModal','$cordovaToast','config','$http','bfgData','$state','$rootScope', function($scope,$location,$interval,$ionicPopup,MediaSrv,$ionicModal,$cordovaToast,config,$http,bfgData,$state,$rootScope) {

	var Urlcall =config.clientUrl;
	sessionStorage.removeItem('newpop');
	sessionStorage['newpage'] = "cancel";	
	$scope.var1=1;
	$scope.var2=2;
	...
	$scope.ord.restaurant_id		=	window.localStorage['restaurant_id'];
		...
		var promise = bfgData.cancelled($scope.ord,config.clientUrl,$state);
