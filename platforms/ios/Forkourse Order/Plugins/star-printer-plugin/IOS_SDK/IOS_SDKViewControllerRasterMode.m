...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        arrayFunction = [[NSArray alloc] initWithObjects:@"Get Firmware Information", @"Get Status", @"Sample Receipt",
                                                         @"Open Cash Drawer 1", @"Open Cash Drawer 2",@"Test Printing",
...
- (void)viewDidLoad
{
    ...
    [AppDelegate setButtonArrayAsOldStyle:@[buttonPort, buttonSearch, buttonSensorActive]];
}
