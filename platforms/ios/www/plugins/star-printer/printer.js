...
var StarPrinterPlugin = function () {
    ...
    this.PRESETTING_PRINTERS_METHOD = 'preSetting';
...
StarPrinterPlugin.prototype.preSetting = function(callback, errorc) {
    // make the call
    var successCallback = (callback && typeof(callback) === 'function') ? callback : this.defaultCallback;
    var errorCallback = (errorc && typeof(errorc) === 'function') ? errorc : this.defaultCallback;
    
    cordova.exec(successCallback, errorCallback, this.CLASS, this.PRESETTING_PRINTERS_METHOD, []);
};
